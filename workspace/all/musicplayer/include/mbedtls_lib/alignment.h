 ...
 */
#if defined(__ARM_FEATURE_UNALIGNED) || defined(MBEDTLS_ARCH_IS_X86) || defined(MBEDTLS_ARCH_IS_X64) || defined(MBEDTLS_PLATFORM_IS_WINDOWS_ON_ARM64)
/*
...
#define MBEDTLS_EFFICIENT_UNALIGNED_ACCESS
	...
	(defined(MBEDTLS_ARCH_IS_ARM64) || defined(MBEDTLS_ARCH_IS_ARM32) || defined(__ICCRX__) || defined(__ICCRL78__) || defined(__ICCRISCV__))
