...
#if defined(MBEDTLS_ECP_LIGHT) && (!defined(MBEDTLS_BIGNUM_C) || (!defined(MBEDTLS_ECP_DP_SECP192R1_ENABLED) &&  \
																  !defined(MBEDTLS_ECP_DP_SECP224R1_ENABLED) &&  \
																  !defined(MBEDTLS_ECP_DP_SECP256R1_ENABLED) &&  \
																  !defined(MBEDTLS_ECP_DP_SECP384R1_ENABLED) &&  \
																  !defined(MBEDTLS_ECP_DP_SECP521R1_ENABLED) &&  \
...
#endif
#if defined(MBEDTLS_ENTROPY_C) && \
	(defined(MBEDTLS_ENTROPY_FORCE_SHA256) || !defined(MBEDTLS_MD_CAN_SHA512)) && defined(MBEDTLS_CTR_DRBG_ENTROPY_LEN) && (MBEDTLS_CTR_DRBG_ENTROPY_LEN > 32)
#error "MBEDTLS_CTR_DRBG_ENTROPY_LEN value too high"
#endif
#if defined(MBEDTLS_ENTROPY_C) && \
